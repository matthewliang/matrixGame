...
A change I made to the design is to not store information in a 2D array since I still need projectiles to move constantly across the screen. Also, I use ArrayLists to store data of projectiles and hearts. This is because there is no inherent ordering of different projectiles and hearts, and it is straightforward to add and remove objects and iterate through objects in ArrayLists.